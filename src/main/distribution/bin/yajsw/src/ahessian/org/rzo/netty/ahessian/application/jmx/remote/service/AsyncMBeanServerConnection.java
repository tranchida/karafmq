...
public interface AsyncMBeanServerConnection
{
	    ...
	    * @throws javax.management.InstanceNotFoundException If the source MBean is not registered in the MBeanServer.
	    * @throws java.io.IOException               If a communication problem occurred.
	    * @see #removeNotificationListener(javax.management.ObjectName, javax.management.NotificationListener, javax.management.NotificationFilter, Object)
	    */
	    ...
	    * @param filter   The filter which will allow the notification to be forwarded to the listener.
	    * @param handback The context to be sent to the listener when a notification is emitted.
	    * @throws javax.management.InstanceNotFoundException If the source or listener MBean are not registered in the MBeanServer.
	    * @throws java.io.IOException               If a communication problem occurred.
	    * @see #removeNotificationListener(javax.management.ObjectName, javax.management.ObjectName, javax.management.NotificationFilter, Object)
	    */
	    ...
	    * @throws javax.management.InstanceNotFoundException If the source MBean is not registered in the MBeanServer.
	    * @throws javax.management.ListenerNotFoundException If the listener is not registered in the MBean.
	    * @throws java.io.IOException               If a communication problem occurred.
	    * @see #addNotificationListener(javax.management.ObjectName, javax.management.NotificationListener, javax.management.NotificationFilter, Object)
	    */
	    ...
	    * @throws javax.management.InstanceNotFoundException If the source or listener MBean are not registered in the MBeanServer.
	    * @throws javax.management.ListenerNotFoundException The listener is not registered in the MBean.
	    * @throws java.io.IOException               If a communication problem occurred.
	    * @see #addNotificationListener(javax.management.ObjectName, javax.management.ObjectName, javax.management.NotificationFilter, Object)
	    */
	    ...
	    * @throws javax.management.InstanceNotFoundException If the source MBean is not registered in the MBeanServer.
	    * @throws javax.management.ListenerNotFoundException If the listener (along with filter and handback) is not registered in the MBean.
	    * @throws java.io.IOException               If a communication problem occurred.
	    * @see #addNotificationListener(javax.management.ObjectName, javax.management.NotificationListener, javax.management.NotificationFilter, Object)
	    * @since JMX 1.2
	    */
	    ...
	    * @throws javax.management.IntrospectionException    If an exception occured during introspection of the MBean.
	    * @throws javax.management.InstanceNotFoundException If the named MBean is not registered in the MBeanServer.
	    * @throws javax.management.ReflectionException       If a reflection-type exception occurred
	    * @throws java.io.IOException               If a communication problem occurred.
	    */
	    ...
	    *
	    * @see #createMBean(String, javax.management.ObjectName, Object[], String[])
	    */
	    ...
	    * The ObjectName may be null if the MBean implements {@link javax.management.MBeanRegistration}
	    *
	    ...
	    * @throws javax.management.ReflectionException            If a reflection exception is thrown.
	    * @throws javax.management.InstanceAlreadyExistsException If another MBean with the same ObjectName is already registered in the MBeanServer.
	    * @throws javax.management.MBeanRegistrationException     If an exception is thrown during MBean's registration.
	    * @throws javax.management.MBeanException                 If the constructor of the MBean has thrown an exception
	    * @throws javax.management.NotCompliantMBeanException     If the MBean is not a JMX compliant MBean
	    * @throws java.io.IOException                    If a communication problem occurred.
	    */
	    ...
	    *
	    * @see #createMBean(String, javax.management.ObjectName, javax.management.ObjectName, Object[], String[])
	    */
	    ...
	    * @throws javax.management.MBeanException                 If the constructor of the MBean has thrown an exception
	    * @throws javax.management.NotCompliantMBeanException     If the MBean is not a JMX compliant MBean
	    * @throws javax.management.InstanceNotFoundException      If the specified classloader MBean is not registered in the MBeanServer.
	    * @throws java.io.IOException                    If a communication problem occurred.
	    */
	    ...
	    * @throws javax.management.InstanceNotFoundException  If the specified MBean is not registered in the MBeanServer.
	    * @throws javax.management.MBeanRegistrationException If an exception is thrown during MBean's unregistration.
	    * @throws java.io.IOException                If a communication problem occurred.
	    */
	    ...
	    * @throws javax.management.AttributeNotFoundException If the specified attribute does not belong to the management interface of the MBean.
	    * @throws javax.management.MBeanException             If the MBean's getter method throws an exception.
	    * @throws javax.management.InstanceNotFoundException  If the specified MBean is not registered in the MBeanServer.
	    * @throws javax.management.ReflectionException        If a reflection exception is thrown.
	    * @throws java.io.IOException                If a communication problem occurred.
	    * @see #setAttribute
	    ...
	    * @throws javax.management.InstanceNotFoundException      If the specified MBean is not registered in the MBeanServer.
	    * @throws javax.management.AttributeNotFoundException     If the specified attribute does not belong to the management interface of the MBean.
	    * @throws javax.management.InvalidAttributeValueException If the value specified for the attribute does not match the attribute's type
	    * @throws javax.management.MBeanException                 If the MBean's setter method throws an exception.
	    * @throws javax.management.ReflectionException            If a reflection exception is thrown.
	    * @throws java.io.IOException                    If a communication problem occurred.
	    * @see #getAttribute
	    */
	    ...
	    * @throws javax.management.InstanceNotFoundException If the specified MBean is not registered in the MBeanServer.
	    * @throws javax.management.MBeanException            If the MBean's operation method throws an exception.
	    * @throws javax.management.ReflectionException       If a reflection exception is thrown.
	    * @throws java.io.IOException               If a communication problem occurred.
	    */
