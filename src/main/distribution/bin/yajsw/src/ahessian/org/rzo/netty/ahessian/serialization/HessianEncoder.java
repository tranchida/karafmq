...
/**
 * Encodes the requested {@link Object} into a {@link ChannelBuffer}.
 ...
 * pipeline.addLast("hessianEncoder", new {@link org.rzo.netty.ahessian.serialization.HessianEncoder}());
 * 
 * // Decoder
 ...
 * </pre>
 * and then, within the handler you can use a {@link Object} instead of a {@link ChannelBuffer}
 * as a message:
 * <pre>
