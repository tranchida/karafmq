 ...
 * Netty should use.  The default factory is {@link JdkLogger2Factory}.
 * You can change it to your preferred logging framework before other Netty
 * classes are loaded:
 * <pre>
 * {@link org.jboss.netty.logging.InternalLoggerFactory}.setDefaultFactory(new {@link Log4JLoggerFactory}());
 * </pre>
 * Please note that the new default factory is effective only for the classes
 * which were loaded after the default factory is changed.  Therefore,
 * {@link #setDefaultFactory(org.jboss.netty.logging.InternalLoggerFactory)} should be called as early
